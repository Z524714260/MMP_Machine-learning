...
# =============================================================================
selected_dataset = 'A'  # <--- CHANGE THIS VALUE TO 'A', 'B', or 'C'
# =============================================================================
...
if selected_dataset == 'A':
    ...
    print(f"Selected Dataset: A")
    print(f"File Path: {file_path}")
    print(f"Test Split Ratio: {test_split_ratio}")
elif selected_dataset == 'B':
    file_path = 'data(B).xlsx'
    test_split_ratio = 0.14
    print(f"Selected Dataset: B")
    print(f"File Path: {file_path}")
    print(f"Test Split Ratio: {test_split_ratio}")
elif selected_dataset == 'C':
    file_path = 'data(C).xlsx'
    test_split_ratio = 0.118
